...
public class Main extends Application {
    ...
    public void start(Stage baseStage) {
        ...
        // Register scenes
        NewUserPageUI.RegisterWithNavigation();
        ...
        UserManagementPage.RegisterWithNavigation();
        ListUsersPageUI.RegisterWithNavigation();
        InviteUserPageUI.RegisterWithNavigation();
        
        // Start with the New User Page
        Navigation.navigateTo("NewUserPage");
    }
}
